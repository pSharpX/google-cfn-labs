...
import com.onebank.taskmaster.sendnotification.sms.model.twilio.TwilioErrorResponse;
...
public class TwilioClientErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        try (InputStream bodyIs = response.body().asInputStream()) {
            TwilioErrorResponse errorResponse = this.objectMapper.readValue(bodyIs, TwilioErrorResponse.class);
