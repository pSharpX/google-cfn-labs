...
public class PlivoConfigModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    @Named("plivoProperties")
    public Properties plivoProperties(final ConfigProvider configProvider) {
        return configProvider.getConfig("task-master.channel.sms.plivo");
    }

    @Provides
    @Singleton
    public PlivoConfigProperties plivoConfigProperties(final ConfigProvider configProvider) {
    ...
    public PlivoClient plivoClient(
        ...
        return Feign.builder()
                ...
                .logLevel(Logger.Level.valueOf(plivoConfigProperties.getLogger().getLevel()))
